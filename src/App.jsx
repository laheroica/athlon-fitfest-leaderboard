...
const PRELOADED_TEAMS = [
  ...
  'GYM TONIC','FRASCO CHICO','Diclo + Piridinol','SIN NOMBRE','CARDIO EN RIESGO','LOS ESCUINCLES'
].map((n,i)=>({ categoria:'Advance', id:`AD-${String(i+1).padStart(3,'0')}`, nombre:n }))).concat([
  // RX
  'LOS RUSOS','PURA GARRA','EMPUJE TEAM','VINCHITAS RX','BURPEANDO ANDO','PAPA Y BATATA','ONICHANS','RAGNAROK'
